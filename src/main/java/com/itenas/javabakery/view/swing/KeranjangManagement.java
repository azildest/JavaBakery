...
//        return testUsername.getName();
    ...
    private void loadData(Keranjang produk) {
        Object[][] objectKeranjang = new Object[1][6];
            ...
            objectKeranjang[0][2] = produk.getJumlah();
            objectKeranjang[0][3] = produk.getHarga();
            objectKeranjang[0][4] = produk.getTotal();
            objectKeranjang[0][5] = produk.getImage();
    ...
    private Keranjang findKeranjang(String name) {
        ...
        keranjangService = new KeranjangServiceImpl();
        keranjang = keranjangService.findProductID(akun.getUsername(), name);
    ...
    public void DecreaseQuantity(String id){
        ...
        keranjangService.decreaseQuantity(akun.getUsername(), id);
        loadData(akun);
    ...
    public void getJumlahProduct(String id){
        int temp;
        
        temp = keranjangService.getJumlahProduct(akun.getUsername(), id);
        //temp = keranjangService.getJumlah();
        
        lblJumlah.setText(temp+"");
    }
    ...
    private void initComponents() {
        ...
        btnDeleteFromCart.setFont(new java.awt.Font("Segoe UI Semibold", 1, 12)); // NOI18N
        btnDeleteFromCart.setIcon(new javax.swing.ImageIcon("C:\\Users\\acer\\Downloads\\remove-from-cart.png")); // NOI18N
        ...
        jDesktopPane4.setLayer(lblImage, javax.swing.JLayeredPane.DEFAULT_LAYER);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btnDeleteFromCart, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel3)
                            .addComponent(lblUsername)))
 ...
 //           produkService.sortByCondition2();
    ...
    private void btnDeleteFromCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteFromCartActionPerformed
        ...
        if(dialogResult == JOptionPane.YES_OPTION){
            keranjangService.deleteProduct(akun.getUsername(), lblIDProduk.getText());
            loadData(akun);
            emptyField();
        }
...
/*        idKeranjang = Integer.parseInt(lblIDKeranjang.getText());
    ...
    private void btnPlusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlusActionPerformed
        ...
        //getJumlahProduct(lblIDProduk.getText());
        emptyField();
    ...
    private void btnMinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMinActionPerformed
        ...
        DecreaseQuantity(lblIDProduk.getText());
        emptyField();
